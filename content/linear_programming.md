title: Minimize your cloud costs with GLPK and Haskell
...
The second constraint tells GLPK that in order to *use* a reserved instance, we need to reserve it first.
